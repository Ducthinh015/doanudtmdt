...
// Chatbot widget is mounted globally in App.jsx for user role
...
const Hero = () => {
  return (
    <div className="min-h-[75vh] flex justify-center items-center px-4 py-8">
      <div className="w-full md:w-4/6 lg:w-3/6 flex flex-col justify-center items-center gap-6 font-sans text-center">
        ...
        <div className="absolute bottom-16 left-1/2 transform -translate-x-1/2 text-center">
          <p className="text-xs md:text-lg lg:text-sm drop-shadow-[0_4px_10px_rgba(0,0,0,0.8)] mb-5">
            Khám phá thế giới sách trên nền tảng đọc sách trực tuyến của chúng tôi.
            <br />
            Đắm mình trong thể loại yêu thích, khám phá tác giả mới
            <br />
            và đọc sách mọi lúc, mọi nơi.
          </p>
      ...
      {/* Chatbot removed here; global widget handles rendering */}
    </div>
  );
};
